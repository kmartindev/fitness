...
/* harmony import */ var _modules_cards__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_cards__WEBPACK_IMPORTED_MODULE_5__);
...
var BELOW_DESKTOP_WIDTH = '(max-width: 1199px)';
var isBelowDesktopWidth = window.matchMedia(BELOW_DESKTOP_WIDTH);
var cards = document.querySelector('.coaches__list');

var onCardClick = function onCardClick(_ref) {
  var target = _ref.target;
  var currentCard = target.closest('[data-el="card"]');
  currentCard.classList.toggle('is-open');
};

var cardsHandler = function cardsHandler() {
...
var tabLinks = document.querySelectorAll('[data-el="tab-link"]');
var tabContents = document.querySelectorAll('[data-el="tab-content"]');

var onTabLinkClick = function onTabLinkClick(_ref) {
  ...
  document.querySelector("#".concat(value)).classList.add('is-active');
...
var form = document.querySelector('[data-el="form"]');
var telField = form.querySelector('[data-el="tel-field"]');
var telInput = form.querySelector('[data-el="tel-input"]');
var telMask = {
  mask: '+{7} (000) 000-00-00'
};
var formTelMask = Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(telInput, telMask);
form.addEventListener('submit', function (evt) {
  evt.preventDefault();
  var telLength = formTelMask.unmaskedValue.length;
...
var videoWrapper = document.querySelector('[data-el="video-wrapper"]');
var videoPlayer = document.querySelector('[data-el="video-player"]');
var videoButton = document.querySelector('[data-el="video-button"]');

var onVideoButtonClick = function onVideoButtonClick() {
  videoWrapper.classList.add('is-active');
  videoPlayer.setAttribute('src', "".concat(videoPlayer.dataset.src));
};
